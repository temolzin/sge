...
<!--*****************************************MODALS****************************************-->
<!--------------------------------------------------------- Modal Registrar----------------------------------------->
<div class="modal fade" id="modalRegistrarTutor" tabindex="-1" role="dialog" aria-labelledby="modalRegistrarTutor"
    aria-hidden="true">
                                        ...
                                        <div class="form-group input-group">
                                            <div class="custom-file">
                                                <input type="file" accept="image/*" class="custom-file-input"
                                                    name="foto_tutor" id="foto_tutor" lang="es">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="4" hidden class="form-control"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input onkeypress="return soloLetras(event)" type="name"
                                                    class="form-control" id="nombre_tutor" name="nombre_tutor"
                                                    placeholder="Nombre" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input onkeypress="return soloLetras(event)" type="family-name"
                                                class="form-control" id="appaterno_tutor" name="appaterno_tutor"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input onkeypress="return soloLetras(event)" type="family-name"
                                                class="form-control" id="apmaterno_tutor" name="apmaterno_tutor"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="fechanacimiento_tutor"
                                                name="fechanacimiento_tutor" placeholder="Fecha nacimiento" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="email" class="form-control" id="email_tutor"
                                                    name="email_tutor" placeholder="Eje. usuario@gmail.com" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Calle (*)</label>
                                            <input type="text" class="form-control" id="calle_tutor" name="calle_tutor"
                                                placeholder="Calle" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="noexterior_tutor"
                                                name="noexterior_tutor" placeholder="Número exterior" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
...
<!--------------------------------------------------------- Modal Actualizar---------------------------------------->
<div class="modal fade" id="modalActualizarTutor" tabindex="-1" role="dialog" aria-labelledby="modalActualizarTutor"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="card-body">
                            ...
                            <div class="card-body border-primary">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group input-group">
                                            <div class="custom-file">
                                            <input type="file" accept="image/*" class="custom-file-input" 
                                            name="imgTutorActualizar" id="imgTutorActualizar" lang="es">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <input type="text" hidden class="form-control" id="id_tutorActualizar"
                                            name="id_tutorActualizar" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input onkeypress="return soloLetras(event)" type="name"
                                                    class="form-control" id="nombre_tutorActualizar"
                                                    name="nombre_tutorActualizar" placeholder="Nombre" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Apellido Paterno (*)</label>
                                            <input onkeypress="return soloLetras(event)" type="family-name"
                                                class="form-control" id="appaterno_tutorActualizar"
                                                name="appaterno_tutorActualizar" placeholder="Apellido Paterno" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Apellido Materno (*)</label>
                                            <input onkeypress="return soloLetras(event)" type="family-name"
                                                class="form-control" id="apmaterno_tutorActualizar"
                                                name="apmaterno_tutorActualizar" placeholder="Apellido Materno" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Fecha nacimiento (*)</label>
                                            <input type="date" class="form-control" id="fechanacimiento_tutorActualizar"
                                                name="fechanacimiento_tutorActualizar" placeholder="Fecha nacimiento" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="tel" id="telefono_tutorActualizar"
                                                    name="telefono_tutorActualizar" class="form-control"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="email" class="form-control" id="email_tutorActualizar"
                                                    name="email_tutorActualizar" placeholder="Eje. usuario@gmail.com" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card border-red">
                            <div class="card-header py-1 bg-secondary ">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-secondary" data-card-widget="collapse"><i
                                            class="fas fa-minus"></i></button>
                                </div>
                                <!-- /.card-tools -->
                            </div>
                            ...
                            <div class="card-body border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Calle (*)</label>
                                            <input type="text" class="form-control" id="calle_tutorActualizar"
                                                name="calle_tutorActualizar" placeholder="Calle" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Número Exterior (*)</label>
                                            <input type="text" class="form-control" id="noexterior_tutorActualizar"
                                                name="noexterior_tutorActualizar" placeholder="Número exterior" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
...
<!--------------------------------------------------------- Modal Detalle------------------------------------------->
<div class="modal fade" id="modalDetalleTutor" tabindex="-1" role="dialog" aria-labelledby="modalDetalleTutor"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                            ...
                            <div class="card-body border-primary">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input disabled type="text" class="form-control" id="id_tutorConsultar"
                                                name="id_tutorConsultar" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Nombre (s) </label>
                                            <input disabled type="text" class="form-control" id="nombre_tutorConsultar"
                                                name="nombre_tutorConsultar" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Apellido Paterno </label>
                                            <input disabled type="text" class="form-control"
                                                id="appaterno_tutorConsultar" name="appaterno_tutorConsultar" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Apellido Materno </label>
                                            <input disabled type="text" class="form-control"
                                                id="apmaterno_tutorConsultar" name="apmaterno_tutorConsultar" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input disabled type="date" class="form-control"
                                                id="fechanacimiento_tutorConsultar"
                                                name="fechanacimiento_tutorConsultar" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Teléfono celular</label>
                                            <input disabled type="tel" class="form-control" id="telefono_tutorConsultar"
                                                name="telefono_tutorConsultar" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Correo electrónico</label>
                                            <input disabled type="email" class="form-control" id="email_tutorConsultar"
                                                name="email_tutorConsultar" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Calle </label>
                                                <input disabled type="text" class="form-control"
                                                    id="calle_tutorConsultar" name="calle_tutorConsultar" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Número Exterior </label>
                                                <input disabled type="text" class="form-control"
                                                    id="noexterior_tutorConsultar" name="noexterior_tutorConsultar" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label> Número interior </label>
                                                <input disabled type="text" class="form-control"
                                                    id="nointerior_tutorConsultar" name="nointerior_tutorConsultar" />
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
...
<!-- ****************************** Modal Eliminar  *************************************************-->
<div class="modal fade" id="modalEliminarTutor" tabindex="-1" role="dialog" aria-labelledby="modalEliminarTutor"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
    ...
    var tableTutor = $('#dataTableTutor').DataTable({
        ...
        "columns": [{
                ...
                'render': function(data, type, JsonResultRow, meta) {
                    var Imagen = JsonResultRow.appaterno_tutor + '_' 
                    + JsonResultRow.apmaterno_tutor + '_' + JsonResultRow.nombre_tutor + '/' + JsonResultRow.foto_tutor;
                    var urlImg = '<?php echo constant('URL'); ?>public/tutor/' + Imagen;
            ...
            },
            {
                defaultContent: "",
                "render": function(data, type, JsonResultRow, meta) {
                    return JsonResultRow.nombre_tutor + ' ' + JsonResultRow.appaterno_tutor + ' ' 
             ...
             { "data": "nombre_alumno" },
            {
                defaultContent: "",
                "render": function(data, type, JsonResultRow, meta) {
                    return JsonResultRow.nombre_alumno + ' ' + JsonResultRow.appaterno_alumno + ' ' 
                    + JsonResultRow.apmaterno_alumno;
                }
            },
            {
                "data": "nombre_escuela"
...
var obtenerdatosDT = function(table) {
    $('#dataTableTutor tbody').on('click', 'tr', function() {
        ...
        console.log(data);
        var idEliminar = $('#idEliminarTutor').val(data.id_tutor);
        var idEliminarUsuario = $('#idEliminarUsuario').val(data.id_usuario);
        var idActualizar = $("#id_tutorActualizar").val(data.id_tutor);
        ...
        var id_alumno = $("#id_alumnoActualizar option[value=" + data.id_alumno + "]").attr("selected",
            true);
        ...
        var estado_tutor = $("#selectEstadoActualizar").append('<option selected>' + data.estado_tutor +
            '</option>');
        $("#selectMunicipioActualizar").empty();
        var municipio_tutor = $("#selectMunicipioActualizar").append('<option selected>' + data
            .municipio_tutor + '</option>');
        $("#selectColoniaActualizar").empty();
        var colonia_tutor = $("#selectColoniaActualizar").append('<option selected>' + data.colonia_tutor +
            '</option>');
        ...
        var id_alumnoConsulta = $("#id_alumnoConsultar option[value=" + data.id_alumno + "]").attr(
            "selected", true);
        ...
        var fechanacimiento_tutorConsulta = $("#fechanacimiento_tutorConsultar").val(data
        ...
        var rutaImagenConsulta = $("#imgTutorConsultar option[value=" + data.id_tutor + "]").attr(
            "selected", true);
    });
}
        ...
        submitHandler: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    form_data.append('id_alumno', document.getElementById('id_alumno')
                        .value);
                    form_data.append('id_escuela', document.getElementById('id_escuela')
                        .value);

                    form_data.append('nombre_tutor', document.getElementById('nombre_tutor')
                        .value);
                    form_data.append('appaterno_tutor', document.getElementById(
                        'appaterno_tutor').value);
                    form_data.append('apmaterno_tutor', document.getElementById(
                        'apmaterno_tutor').value);
                    form_data.append('fechanacimiento_tutor', document.getElementById(
                        'fechanacimiento_tutor').value);
                    form_data.append('telefono_tutor', document.getElementById(
                        'telefono_tutor').value);
                    form_data.append('email_tutor', document.getElementById('email_tutor')
                        .value);
                    form_data.append('calle_tutor', document.getElementById('calle_tutor')
                        .value);
                    form_data.append('noexterior_tutor', document.getElementById(
                        'noexterior_tutor').value);
                    form_data.append('nointerior_tutor', document.getElementById(
                        'nointerior_tutor').value);
                        ...
                        success: function(data) {
                            ...
                            if (data == 'ok') {
                                Swal.fire(
                                    ...
                                    window.location =
                                        "<?php echo constant('URL'); ?>tutor";
                                })
                            } else {
                                Swal.fire(
                                    "¡Error!",
                                    "Ha ocurrido un error al registrar el tutor. " +
                                    data,
                                    "error"
                                );
                            }
...
var enviarFormularioActualizar = function() {
    $.validator.setDefaults({
        submitHandler: function() {
            ...
            form_data.append('id_alumnoActualizar', document.getElementById('id_alumnoActualizar')
                .value);
            form_data.append('id_escuelaActualizar', document.getElementById('id_escuelaActualizar')
                .value);

            form_data.append('nombre_tutorActualizar', document.getElementById('nombre_tutorActualizar')
                .value);
            form_data.append('appaterno_tutorActualizar', document.getElementById(
                'appaterno_tutorActualizar').value);
            form_data.append('apmaterno_tutorActualizar', document.getElementById(
                'apmaterno_tutorActualizar').value);
            form_data.append('fechanacimiento_tutorActualizar', document.getElementById(
                'fechanacimiento_tutorActualizar').value);
            form_data.append('telefono_tutorActualizar', document.getElementById(
                'telefono_tutorActualizar').value);
            form_data.append('email_tutorActualizar', document.getElementById('email_tutorActualizar')
                .value);
            form_data.append('calle_tutorActualizar', document.getElementById('calle_tutorActualizar')
                .value);
            form_data.append('noexterior_tutorActualizar', document.getElementById(
                'noexterior_tutorActualizar').value);
            form_data.append('nointerior_tutorActualizar', document.getElementById(
                'nointerior_tutorActualizar').value);
