                                ...
                                <div class="col-12 col-sm-12">
                                    ...
                                    <div class="form-group input-group">
                                      <div class="custom-file">
                                        <input type="file" accept="image/*" class="custom-file-input" name="foto_tutor" id="foto_tutor" 
                                        lang="es">
...
<script>
  ...
  document.getElementById('imgTutorActualizar').value= nombre; 
    ...
    var mostrarTutores = function() {
        ...
        {data:null,
            "defaultContent":
            `<button class='consulta btn btn-primary' data-toggle='modal' data-target='#modalDetalleTutor' title="Ver Detalles">
