               ...
               <div class="row m-l-0 m-r-0">
                  <div class="col-sm-4 bg-c-lite-green user-profile" style="  background: linear-gradient(to bottom, #003399 0%, #33cccc 100%);">
                     <div class="card-block text-center text-white">
                        <img src="<?php echo $fotoruta; ?>" alt="user-avatar" class="rounded-circle img-thumbnail" style="max-width: 145px; max-height: 145px;"><br><br>
                  ...
                  <div class="offset-lg-12 col-lg-12 col-sm-12 col-12 main-section text-center">
                     ...
                     <div class="row user-detail">
                        <div class="col-lg-12 col-sm-12 col-12">
                           <img src="<?php echo $fotoruta; ?>" class="img-circle img-fluid" height="145px" width="145px">
