...
<body>
    ...
    <div id="alertNO" class="alert alert-warning" role="alert">
    <span class="msg"><strong>¡Error!</strong> Complete los datos</span>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <div class="login">
        <div class="login_image">
            <center><img src="<?php constant('URL'); ?>public/img/escuela.png"
                    class="rounded-circle elevation-2 img-fluid" style="height: 105px;"></center>
        </div>
        ...
        <form class="signin-form" id="formEnviarLogin" name="formEnviarLogin" role="form">
            <div class="login_fields">
                <div class="login_fields__user form-group">
                    ...
                    <input placeholder="Usuario" type="text" id="username_usuario" name="username_usuario"
                ...
                <div class="login_fields__password form-group">
                    ...
                    <input type="password" id="password_usuario" name="password_usuario" class="form-control"
...
$("#formEnviarLogin").submit(function(e) {
        ...
        if (username_usuario.length > 0 && password_usuario.length > 0) {
        } else {
