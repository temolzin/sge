<?php
   ...
   $menu = new Menu();
   $menu->header('calificacion_consulta');
   ?>
      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               ...
               <!-- /.card-header -->
               <div class="card-body">
                  <table id="dataTableCalificacionAlumno" name="dataTableCalificacionAlumno" class="table table-bordered table-hover dt-responsive nowrap" style="width:100%">
                     <thead>
                        <tr>
                           <th>Parcial</th>
                           <th>Materia</th>
...
<script>
   ...
   var mostrarCalificaciones = function () {
     var tableCalificacion = $('#dataTableCalificacionAlumno').DataTable({
       ...
       "serverSide": false,
       "ajax": {
         "url": "<?php echo constant('URL');?>calificacion_consulta/readTable"
       },
       "columns": [
         {
           "data": "nombre_parcial"
   ...
   var obtenerdatosDT = function (table) {
     $('#dataTableCalificacionAlumno tbody').on('click', 'tr', function () {
