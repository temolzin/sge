      ...
      var mostrarIncidencias = function() {
        var tableIncidencia = $('#dataTableIncidencias').DataTable({
          ...
          "columns": [{
            ...
            {
              data: null,
              "defaultContent": `<button class='consulta btn btn-primary' data-toggle='modal' data-target='#modalDetalleIncidencia' title="Ver Detalles"><i class="fa fa-eye"></i></button>
