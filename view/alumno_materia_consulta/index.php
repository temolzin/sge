...
<script>
 ...
 var obtenerdatosDT = function (table) {
        $('#dataTableAlumnoMateriaTutor tbody').on('click', 'tr', function() {
 ...
 var mostrarMaterias = function() {
        var tableMateria = $('#dataTableAlumnoMateriaTutor').DataTable({
            "processing": true,
            "serverSide": false,
            "ajax": {
                "url": "<?php echo constant('URL');?>alumno_materia_consulta/readTable"
            },
            "columns": [
