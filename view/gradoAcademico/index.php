  ...
  var mostrarGrados = function() {
    var tableGradoAcademico = $('#dataTableGradoAcademico').DataTable({
      ...
      "columns": [
        ...
        {
          data: null,
          "defaultContent": `<button class='consulta btn btn-primary' data-toggle='modal' data-target='#modalDetalleGradoAcademico' title="Ver Detalles"><i class="fa fa-eye"></i></button>
