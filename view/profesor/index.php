                    ...
                    <div class="col-12 col-sm-12">
                      ...
                      <div class="form-group input-group">
                        <div class="custom-file">
                          ...
                          name="foto_profesorActualizar" id="foto_profesorActualizar" lang="es">
                  ...
                  <div class="card-body border-primary">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        name="telefono_profesorConsultar" placeholder="Introduce el numero telefonico"/>
                      </div>
                    </div>
...
function leerCodigoPostal(codigoPostal){ 
    ...
    return result;
      ...
      {data:null,
        "defaultContent":
        `<button class='consulta btn btn-primary' data-toggle='modal' data-target='#modalDetalleProfesor' title="Ver Detalles"><i class="fa fa-eye"></i></button>
