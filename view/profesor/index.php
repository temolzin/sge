    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-right">
                <button class="btn btn-success" data-toggle='modal' data-target='#modalRegistrarProfesor'> <i
                        class="fas fa-plus-circle"></i> Registrar Profesor
                </button>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="dataTableProfesor" name="dataTableProfesor"
...
<!--- Modal Registrar--->
<div class="modal fade" id="modalRegistrarProfesor" tabindex="-1" role="dialog" aria-labelledby="modalRegistrarProfesor"
    aria-hidden="true">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group input-group">
                                            <div class="custom-file">
                                                <input type="file" accept="image/*" class="custom-file-input"
                                                    name="foto_profesor" id="foto_profesor" lang="es">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Usuario (*)</label>
                                            <input type="number" value="3" hidden class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input onkeypress="return soloLetras(event)" type="name"
                                                    class="form-control" id="nombre_profesor" name="nombre_profesor"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input onkeypress="return soloLetras(event)" type="family-name"
                                                class="form-control" id="appaterno_profesor" name="appaterno_profesor"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input onkeypress="return soloLetras(event)" type="family-name"
                                                class="form-control" id="apmaterno_profesor" name="apmaterno_profesor"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="tel" id="telefono_profesor" name="telefono_profesor"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="email" class="form-control" id="email_profesor"
                                                    name="email_profesor" placeholder="Eje. usuario@gmail.com" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="fechanacimiento_profesor"
                                                name="fechanacimiento_profesor"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cedula_profesor"
                                                name="cedula_profesor" placeholder="Introduce la cedula profesional" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label>Calle (*)</label>
                                            <input type="street-address" class="form-control" id="calle_profesor"
                                                name="calle_profesor" placeholder="Calle" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>No. exterior (*)</label>
                                            <input type="text" class="form-control" id="numexterior_profesor"
                                                name="numexterior_profesor" placeholder="No. exterior" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input onfocusout="findCp(this);" type="postal-code" class="form-control"
                                                id="codigoPostal" name="codigoPostal" placeholder="Codigo Postal" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
...
<!--------------------------------------------------------- Modal Actualizar----------------------------------------------->
<div class="modal fade" id="modalActualizarProfesor" tabindex="-1" role="dialog"
    aria-labelledby="modalActualizarProfesor" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form role="form" id="formActualizarProfesor" name="formActualizarProfesor">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border-primary">
                                <div class="row">
                                    <input type="text" hidden class="form-control" id="id_profesorActualizar"
                                        name="id_profesorActualizar" />
                                    <input type="text" hidden class="form-control" id="id_usuarioActualizar"
                                        ...
                                        <div class="form-group input-group">
                                            <div class="custom-file">
                                                <input type="file" accept="image/*" class="custom-file-input"
                                                    name="foto_profesorActualizar" id="foto_profesorActualizar"
                                                    lang="es">
                                                <label id="foto_profesorActualizar" class="custom-file-label"
                                                    name="foto_profesorActualizar" id="foto_profesorActualizar"
                                                    for="imagen">Selecciona Imagen</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input onkeypress="return soloLetras(event)" type="name"
                                                    class="form-control" id="nombre_profesorActualizar"
                                                    name="nombre_profesorActualizar" placeholder="Nombre" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="tel" id="telefono_profesorActualizar"
                                                    name="telefono_profesorActualizar" class="form-control"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="email" class="form-control" id="email_profesorActualizar"
                                                    name="email_profesorActualizar"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>No. interior </label>
                                            <input type="text" class="form-control" id="numinterior_profesorActualizar"
                                                name="numinterior_profesorActualizar" placeholder="No. interior " />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
...
<div class="modal fade" id="modalDetalleProfesor" tabindex="-1" role="dialog" aria-labelledby="modalDetalleProfesor"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border-primary">
                                <div class="row">
                                    ...
                                    <input type="text" hidden class="form-control" id="id_profesorConsultar"
                                        name="id_profesorConsultar" />

                                    <input type="text" hidden class="form-control" id="id_usuarioConsultar"
                                        name="id_usuarioConsultar" />
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Usuario</label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled class="form-control"
                                                id="nombre_profesorConsultar" name="nombre_profesorConsultar"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Apellido Paterno</label>
                                            <input type="text" disabled class="form-control"
                                                id="appaterno_profesorConsultar" name="appaterno_profesorConsultar"
                                                placeholder="Introduce el Apellido paterno" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Apellido Materno</label>
                                            <input type="text" disabled class="form-control"
                                                id="apmaterno_profesorConsultar" name="apmaterno_profesorConsultar"
                                                placeholder="Introduce el apellido materno" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Teléfono</label>
                                            <input type="text" disabled class="form-control"
                                                id="telefono_profesorConsultar" name="telefono_profesorConsultar"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="text" disabled class="form-control"
                                                id="email_profesorConsultar" name="email_profesorConsultar"
                                                placeholder="Introduce el email_profesor" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" disabled class="form-control"
                                                id="fechanacimiento_profesorConsultar"
                                                name="fechanacimiento_profesorConsultar"
                                                placeholder="Introduce la fecha de nacimiento" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select disabled name="id_escuelaConsultar" id="id_escuelaConsultar"
                                                class="form-control id_escuela"></select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Cédula profesional</label>
                                            <input type="text" disabled class="form-control"
                                                id="cedula_profesorConsultar" name="cedula_profesorConsultar"
                                                placeholder="Introduce la cedula_profesor" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label>Calle</label>
                                            <input type="text" disabled class="form-control"
                                                id="calle_profesorConsultar" name="calle_profesorConsultar"
                                                placeholder="Calle" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>No. exterior </label>
                                            <input type="text" disabled class="form-control"
                                                id="numexterior_profesorConsultar" name="numexterior_profesorConsultar"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>No. interior </label>
                                            <input type="text" disabled class="form-control"
                                                id="numinterior_profesorConsultar" name="numinterior_profesorConsultar"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Código Postal </label>
                                            <input disabled type="text" class="form-control" id="codigoPostalConsultar"
                                                name="codigoPostalConsultar" placeholder="Codigo Postal" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Colonia </label>
                                            <input disabled name="selectColoniaConsultar" id="selectColoniaConsultar"
...
<div class="modal fade" id="modalEliminarProfesor" tabindex="-1" role="dialog" aria-labelledby="modalEliminarProfesor"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        ...
        "columns": [

            {
                ...
                "render": function(data, type, full, row) {
                    ...
                    var fullnameImagen = full['appaterno_profesor'] + '_' 
                    + full['apmaterno_profesor'] + '_' + full['nombre_profesor'] + '/' + full['foto_profesor'];
                    var urlImg = '<?php echo constant('URL'); ?>public/profesor/' + fullnameImagen;
                    var img = new Image();
                    img.src = urlImg;
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    return full['nombre_profesor'] + ' ' + full['appaterno_profesor'] + ' ' + full[
                        'apmaterno_profesor'];
                }
            },
            {
...
var obtenerform_dataDT = function(table) {
    $('#dataTableProfesor tbody').on('click', 'tr', function() {
        ...
        var estado_profesor = $("#selectEstadoActualizar").append('<option selected>' + data
            .estado_profesor + '</option>');
        $("#selectMunicipioActualizar").empty();
        var municipio_profesor = $("#selectMunicipioActualizar").append('<option selected>' + data
            .municipio_profesor + '</option>');
        $("#selectColoniaActualizar").empty();
        var colonia_profesor = $("#selectColoniaActualizar").append('<option selected>' + data
            .colonia_profesor + '</option>');
        ...
        var fechanacimiento_profesor = $("#fechanacimiento_profesorActualizar").val(data
        ...
        var fechanacimiento_profesorConsulta = $("#fechanacimiento_profesorConsultar").val(data
            .fechanacimiento_profesor);
        var calle_profesorConsulta = $("#calle_profesorConsultar").val(data.calle_profesor);
        var numexterior_profesorConsulta = $("#numexterior_profesorConsultar").val(data
            .numexterior_profesor);
        var numinterior_profesorConsulta = $("#numinterior_profesorConsultar").val(data
        ...
        submitHandler: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    form_data.append('nombre_profesor', document.getElementById(
                        'nombre_profesor').value);
                    form_data.append('appaterno_profesor', document.getElementById(
                        'appaterno_profesor').value);
                    form_data.append('apmaterno_profesor', document.getElementById(
                        'apmaterno_profesor').value);
                    form_data.append('cedula_profesor', document.getElementById(
                        'cedula_profesor').value);
                    form_data.append('telefono_profesor', document.getElementById(
                        'telefono_profesor').value);
                    form_data.append('email_profesor', document.getElementById(
                        'email_profesor').value);
                    form_data.append('fechanacimiento_profesor', document.getElementById(
                        'fechanacimiento_profesor').value);
                    ...
                    form_data.append('id_escuela', document.getElementById('id_escuela')
                        .value);
                    form_data.append('calle_profesor', document.getElementById(
                        'calle_profesor').value);
                    form_data.append('numinterior_profesor', document.getElementById(
                        'numinterior_profesor').value);
                    form_data.append('numexterior_profesor', document.getElementById(
                        'numexterior_profesor').value);
                        ...
                        success: function(data) {
                            ...
                            if (data == 'ok') {
                                Swal.fire(
                                    ...
                                    window.location =
                                        "<?php echo constant('URL'); ?>profesor";
                                })
                            } else {
                                Swal.fire(
                                    "¡Error!",
                                    "Ha ocurrido un error al registrar el profesor. " +
                                    data,
                                    "error"
                                );
                            }
...
var enviarFormularioActualizar = function() {
    $.validator.setDefaults({
        submitHandler: function() {
            ...
            form_data.append('id_profesorActualizar', document.getElementById('id_profesorActualizar')
                .value);
            ...
            form_data.append('id_escuelaActualizar', document.getElementById('id_escuelaActualizar')
                .value);
            form_data.append('nombre_profesorActualizar', document.getElementById(
                'nombre_profesorActualizar').value);
            form_data.append('appaterno_profesorActualizar', document.getElementById(
                'appaterno_profesorActualizar').value);
            form_data.append('apmaterno_profesorActualizar', document.getElementById(
                'apmaterno_profesorActualizar').value);
            form_data.append('cedula_profesorActualizar', document.getElementById(
                'cedula_profesorActualizar').value);
            form_data.append('calle_profesorActualizar', document.getElementById(
                'calle_profesorActualizar').value);
            form_data.append('numinterior_profesorActualizar', document.getElementById(
                'numinterior_profesorActualizar').value);
            form_data.append('numexterior_profesorActualizar', document.getElementById(
                'numexterior_profesorActualizar').value);
            ...
            form_data.append('telefono_profesorActualizar', document.getElementById(
                'telefono_profesorActualizar').value);
            form_data.append('email_profesorActualizar', document.getElementById(
                'email_profesorActualizar').value);
            form_data.append('fechanacimiento_profesorActualizar', document.getElementById(
                'fechanacimiento_profesorActualizar').value);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 'ok') {
                            ...
                            Swal.fire(
                                "¡Error!",
                                "Ha ocurrido un error al eliminar el registro del PROFESOR. " +
                                data,
                                "error"
                            );
                        }
