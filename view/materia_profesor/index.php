                            ...
                            <div class="card-body border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Grupo (*)</label>
                                            <select name="id_grupoActualizar" id="id_grupoActualizar" 
                                            class="form-control id_grupo">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Materia (*)</label>
                                        <select multiple name="id_materiaActualizar" id="id_materiaActualizar" 
                                        class="form-control id_materia" 
                                        data-placeholder="Para visulizar las materias">
...
var mostrarMaterias = function() {
    var tableMateria = $('#dataTableMateriaProfesor').DataTable({
        ...
        "serverSide": false,
        "ajax": {
            "url": "<?php echo constant('URL');?>materia_profesor/readTable"
        },
        "columns": [
        { defaultContent: "",
...
var enviarFormularioRegistrar = function () {
    $.validator.setDefaults({
        submitHandler: function () {
         ...
         $.ajax({
            type: "POST",
            url: "<?php echo constant('URL');?>materia_profesor/insert",
            data: datos,
                ...
                if (data == 'ok') {
                    Swal.fire(
                        ...
                        "success"
                            ...
                            window.location = "<?php echo constant('URL');?>materia_profesor";
                        })
                    } else {
                        Swal.fire(
                            "¡Error!",
...
var enviarFormularioActualizar = function () {
    $.validator.setDefaults({
        submitHandler: function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo constant('URL');?>materia_profesor/update",
                data: datos,
                success: function (data) {
                    if (data == 'ok') {
                        Swal.fire(
...
var eliminarRegistro = function () {
    $( "#formEliminarMateriaProfesor" ).submit(function( event ) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo constant('URL');?>materia_profesor/delete",
            data: datos,
            success: function (data) {
                if (data == 'ok') {
                    Swal.fire(
