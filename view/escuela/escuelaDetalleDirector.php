    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-right">
                <button class="btn btn-success" data-toggle='modal' data-target='#modalRegistrarEscuela'><i
                            class="fas fa-plus-circle"></i> Registrar Escuela
                </button>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="dataTableEscuela" name="dataTableEscuela"
...
<div class="modal fade" id="modalRegistrarEscuela" tabindex="-1" role="dialog" aria-labelledby="modalRegistrarEscuela"
     aria-hidden="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre_escuela"
                                                   name="nombre_escuela" placeholder="Nombre Escuela"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>RFC</label>
                                            <input type="text" class="form-control" id="rfc_escuela" name="rfc_escuela"
                                                   placeholder="RFC"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>CCT</label>
                                            <input type="text" class="form-control" id="cct_escuela" name="cct_escuela"
                                                   placeholder="CCT"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="telefono_escuela"
                                                   name="telefono_escuela" placeholder="Telefono"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="text" class="form-control" id="email_escuela"
                                                   name="email_escuela" placeholder="Email"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <label>Observacion Escuela</label>
                                            <input type="text" class="form-control" id="observacion_escuela"
                                                   name="observacion_escuela" placeholder="Observacion Escuela"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="calle_escuela" id="calle_escuela"
                                                   placeholder="Calle Escuela"/>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="numxterior_escuela"
                                                   name="numxterior_escuela" placeholder="Numero Exterior"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Numero Interior</label>
                                            <input type="text" class="form-control" id="numinterior_escuela"
                                                   name="numinterior_escuela" placeholder="Numero Interior"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Codigo Postal (*)</label>
                                            <input onfocusout="findCp(this);" type="text" class="form-control"
...
<!--------------------------------------------------------- Modal Actualizar----------------------------------------------->
<div class="modal fade" id="modalActualizarEscuela" tabindex="-1" role="dialog" aria-labelledby="modalActualizarEscuela"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" hidden class="form-control" id="id_escuelaActualizar"
                                                   name="id_escuelaActualizar" placeholder="id"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Nombre Escuela</label>
                                            <input type="text" class="form-control" id="nombre_escuelaActualizar"
                                                   name="nombre_escuelaActualizar" placeholder="Nombre Escuela"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>RFC</label>
                                            <input type="text" class="form-control" id="rfc_escuelaActualizar"
                                                   name="rfc_escuelaActualizar" placeholder="RFC"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>CCT</label>
                                            <input type="text" class="form-control" id="cct_escuelaActualizar"
                                                   name="cct_escuelaActualizar" placeholder="CCT"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Telefono</label>
                                            <input type="text" class="form-control" id="telefono_escuelaActualizar"
                                                   name="telefono_escuelaActualizar" placeholder="Telefono"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="text" class="form-control" id="email_escuelaActualizar"
                                                   name="email_escuelaActualizar" placeholder="Email"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Observacion</label>
                                            <input type="text" class="form-control" id="observacion_escuelaActualizar"
                                                   name="observacion_escuelaActualizar" placeholder="Observacion"/>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Calle Escuela</label>
                                            <input class="form-control" name="calle_escuelaActualizar"
                                                   id="calle_escuelaActualizar" placeholder="Calle Escuela"/>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Numero Exterior</label>
                                            <input type="text" class="form-control" id="numxterior_escuelaActualizar"
                                                   name="numxterior_escuelaActualizar" placeholder="Numero Exterior"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Numero Interior</label>
                                            <input type="text" class="form-control" id="numinterior_escuelaActualizar"
                                                   name="numinterior_escuelaActualizar" placeholder="Numero Interior"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Estado</label>
                                            <select class="form-control estado" id="selectEstadoActualizar"
                                                    name="selectEstadoActualizar" placeholder="Estado">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Municipio</label>
                                            <select class="form-control municipio" id="selectMunicipioActualizar"
                                                    name="selectMunicipioActualizar" placeholder="Municipio">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Colonia</label>
                                            <select class="form-control colonia" id="selectColoniaActualizar"
                                                    name="selectColoniaActualizar" placeholder="Municipio">
...
<div class="modal fade" id="modalDetalleEscuela" tabindex="-1" role="dialog" aria-labelledby="modalDetalleEscuela"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label hidden>Id (*)</label>
                                            <input type="text" hidden class="form-control" id="id_escuelaConsultar"
                                                   name="id_escuelaConsultar" placeholder="id"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control"
                                                   id="nombre_escuelaConsultar" name="nombre_escuelaConsultar"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>RFC</label>
                                            <input readonly type="text" class="form-control" id="rfc_escuelaConsultar"
                                                   name="rfc_escuelaConsultar" placeholder="RFC"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>CCT</label>
                                            <input readonly type="text" class="form-control" id="cct_escuelaConsultar"
                                                   name="cct_escuelaConsultar" placeholder="CCT"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Telefono</label>
                                            <input readonly type="text" class="form-control"
                                                   id="telefono_escuelaConsultar" name="telefono_escuelaConsultar"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input readonly type="text" class="form-control" id="email_escuelaConsultar"
                                                   name="email_escuelaConsultar" placeholder="Email"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control"
                                                   id="observacion_escuelaConsultar" name="observacion_escuelaConsultar"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Calle Escuela</label>
                                            <input readonly class="form-control" name="calle_escuelaConsultar"
                                                   id="calle_escuelaConsultar" placeholder="Calle Escuela"/>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Numero Exterior</label>
                                            <input readonly type="text" class="form-control"
                                                   id="numxterior_escuelaConsultar" name="numxterior_escuelaConsultar"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Numero Interior</label>
                                            <input readonly type="text" class="form-control"
                                                   id="numinterior_escuelaConsultar" name="numinterior_escuelaConsultar"
                                                   placeholder="Numero Interior"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input disabled name="selectMunicipioConsultar"
                                                   id="selectMunicipioConsultar" class="form-control">
                                            <option value="default"></option>
...
<div class="modal fade" id="modalEliminarEscuela" tabindex="-1" role="dialog" aria-labelledby="modalEliminarEscuela"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
