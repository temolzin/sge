<?php
    class Directivo_mostrar extends Controller
    {
        ...
        function index(){
            $this->view->render('directivo_mostrar/index');
        }
        ...
        //$nombreImagen = date("Y-n-j");
            ...
            require 'model/directivo_mostrarDAO.php';
            $this->loadModel('Directivo_mostrarDAO');
            $directivo_mostrarDAO = new Directivo_mostrarDAO();
            $directivo_mostrarDAO->insert($data);
        }
    }
}
        ...
        function update() {
            ...
            $this->loadModel('Directivo_mostrarDAO');
            $directivo_mostrarDAO = new Directivo_mostrarDAO();
            $directivo_mostrarDAO->update($data);
        }
        }
    }
        ...
        function delete(){
            ...
            $this->loadModel('Directivo_mostrarDAO');
            $directivo_mostrarDAO = new Directivo_mostrarDAO();
            $directivo_mostrarDAO->delete($id_director);
        }
        ...
        function read() {
            ...
            $this->loadModel('Directivo_mostrarDAO');
            $directivo_mostrarDAO = new Directivo_mostrarDAO();
            $directivo_mostrarDAO = $directivo_mostrarDAO->read();
