<?php
class Consulta_profesor_alumno extends Controller
{
    ...
    function index(){
        $this->view->render('consulta_profesor_alumno/index');
    }
    ...
    function insert() {
        ...
        if($_FILES["foto_alumno"]["name"] != null) {
            ...
            if ($tipoImagen != 'image/jpg' && $tipoImagen != 'image/jpeg' && $tipoImagen != 'image/png' && $tipoImagen != 'image/gif')       {
                ...
                require 'model/consulta_profesor_alumnoDAO.php';
                $this->loadModel('Consulta_profesor_alumnoDAO');
                $consulta_profesor_alumnoDAO = new Consulta_profesor_alumnoDAO();
                $consulta_profesor_alumnoDAO->insert($data);
            }
        }
    }
    ...
    function update() {
        ...
        if($_FILES["foto_alumnoActualizar"]["name"] != null) {
            ...
            if ($tipoImagen != 'image/jpg' && $tipoImagen != 'image/jpeg' && $tipoImagen != 'image/png' && $tipoImagen != 'image/gif')       {
                ...
                $this->loadModel('Consulta_profesor_alumnoDAO');
                $consulta_profesor_alumnoDAO = new Consulta_profesor_alumnoDAO();
                $consulta_profesor_alumnoDAO->update($data);
            } } }
            ...
            function delete(){
                ...
                $this->loadModel('Consulta_profesor_alumnoDAO');
                $consulta_profesor_alumnoDAO = new Consulta_profesor_alumnoDAO();
                $consulta_profesor_alumnoDAO->delete($id_alumno);
            }
            ...
            function read() {
                ...
                $this->loadModel('Consulta_profesor_alumnoDAO');
                $consulta_profesor_alumnoDAO = new Consulta_profesor_alumnoDAO();
                $consulta_profesor_alumnoDAO = $consulta_profesor_alumnoDAO->read();
                echo json_encode($consulta_profesor_alumnoDAO);
            }
            ...
            function readTable() {
                ...
                $obj = null;
                if (is_array($consulta_profesor_alumnoDAO) || is_object($consulta_profesor_alumnoDAO))
                {
                    foreach ($consulta_profesor_alumnoDAO as $key => $value) {
                        $obj["data"][] = $value;
                    }
                } else {
                    $obj = array();
