...
class MateriaDAO extends Model implements CRUD
{
    ...
    public function readMateriaTutor()
    {
        ...
        require_once 'materiaDTO.php';
        $query = "SELECT materia.*, horario_materia.*, escuela.*, tutor.nombre_tutor, alumno.nombre_alumno 
        FROM materia materia, horario_materia horario_materia, alumno alumno , escuela escuela, tutor tutor 
