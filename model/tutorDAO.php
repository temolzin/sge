...
class TutorDAO extends Model implements CRUD
{
    ...
    public function read()
    {
        ...
        FROM escuela, alumno, tutor, usuario, director
        WHERE usuario.id_usuario = tutor.id_usuario and tutor.id_alumno = alumno.id_alumno and tutor.id_escuela = escuela.id_escuela
        and alumno.id_escuela = tutor.id_escuela and alumno.id_escuela = escuela.id_escuela and director.id_escuela = '" . $id_escuela . "'";
        $objTutores = array();
